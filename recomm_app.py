...
# Load Data
df = pd.read_csv(r"C:\Users\ashwi\GUVI_Projects\Book\cleaned_books_data.csv", encoding="utf-8-sig")
...
if st.button(" Get Recommendations"):
    def filter_and_recommend(df, book_name, num_recommendations=5):
        ...
        st.dataframe(content_recs[["Book Name", "Author", "Genre","Description","Number of Ratings", "Rating","Listening Time","Price"]])
        ...
        #  **Top 10 Most Popular Genres (Excluding Unknown)**
        fig, ax = plt.subplots()
        ...
        ax.set_title(" Top Authors with Most Books")
        st.pyplot(fig)
